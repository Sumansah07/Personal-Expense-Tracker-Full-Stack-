...
expenseRouter.post("/ai/expense-insight", requireAuth, require("../controllers/expenseControllers").get_expense_insight);

// AI-powered budget recommendation endpoint
expenseRouter.get("/ai/budget-recommendation", requireAuth, require("../controllers/expenseControllers").get_budget_recommendation);
